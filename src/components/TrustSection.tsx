...
export function TrustSection() {
  return (
    <>
      {/* Payments Section */}
      <section id="payments" className="pt-0 pb-16 section-bg-tactile text-black">
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="text-center mb-10">
            <h2 className="text-h2 mb-3">Fast, Secure & Flexible Payments</h2>
            <p className="text-zinc-600 text-sm font-medium max-w-2xl mx-auto">Multiple methods tailored for Asian traders. Most deposits processed instantly.</p>
          </div>
          ...
          <div className="flex justify-center items-center gap-4 text-zinc-500 font-bold text-[10px]">
      ...
      <section className="py-24 px-6 section-bg-tactile">
        <div className="max-w-[1200px] mx-auto">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-[#121212] border border-white/5 rounded-[2rem] md:rounded-[3rem] p-8 md:p-20 text-center relative overflow-hidden shadow-2xl text-white"
          >
